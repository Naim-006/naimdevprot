...
export const WALLPAPERS: WallpaperDef[] = [
  // === Windows & iOS Defaults ===
  { id: 'win11-bloom', name: 'Windows 11 Bloom', url: 'linear-gradient(135deg, #1a0533 0%, #2d1b69 20%, #6b2142 40%, #c0392b 60%, #e67e22 80%, #f1c40f 100%)' },
  { id: 'win11-wave', name: 'Windows 11 Wave', url: 'linear-gradient(160deg, #0d1117 0%, #161b22 20%, #1f2937 40%, #374151 60%, #4b5563 80%, #6b7280 100%)' },
  { id: 'win10-hero', name: 'Windows 10 Hero', url: 'linear-gradient(135deg, #0a0a0a 0%, #1a1a2e 15%, #16213e 35%, #0f3460 55%, #1a5276 75%, #2e86c1 100%)' },
  { id: 'ios17-stock', name: 'iOS 17 Default', url: 'linear-gradient(135deg, #0c0c1d 0%, #1a0a3e 15%, #4a1942 35%, #c0392b 55%, #e67e22 75%, #f39c12 100%)' },
  { id: 'ios-glow', name: 'iOS Glow', url: 'linear-gradient(135deg, #0a0a2e 0%, #1a0a3e 20%, #5b2c6f 40%, #a569bd 55%, #85c1e9 75%, #a3e4d7 100%)' },
  { id: 'ios-mountains', name: 'iOS Mountains', url: 'linear-gradient(180deg, #0b1525 0%, #1a2a4a 20%, #2c4c6b 40%, #4a7c9e 60%, #6ba3c9 80%, #a8d8ea 100%)' },
  { id: 'win-classic', name: 'Windows Classic', url: 'linear-gradient(180deg, #0c1445 0%, #1a237e 25%, #283593 50%, #1565c0 75%, #42a5f5 100%)' },
  // === Colorful Gradients (CSS, instant load) ===
  ...
  { id: 'snow-mountain', name: 'Snow Mountain', url: 'https://images.unsplash.com/photo-1454496522488-7a8e488e8606?auto=format&fit=crop&w=1920&q=80' },
